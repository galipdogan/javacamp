...
import kodlamaio.northwind.dataAccess.abstratcs.ProductDao;
import kodlamaio.northwind.entities.concretes.Product;

@Service
public class ProductManager implements kodlamaio.northwind.business.abstratcs.ProductService {

	private kodlamaio.northwind.dataAccess.abstratcs.ProductDao productDao;

	@Autowired // productdao içerisinde somut olan sınıfı tarayıp buluyor new leyip getiriyor
