...
@RestController
@RequestMapping("api/products") // eğer bana istek gelirse burası karşılayacak
public class ProductsController {
	...
	@GetMapping("/getall") // burası da üst classdan api/products alacak ve /getall çalıştıracak burda
							// route yapısı oluşturduk bir nevi
